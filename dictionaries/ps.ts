// مسیر فایل: dictionaries/ps.ts
//
// 🛠️ رفعِ باگِ متنیِ جامانده (بازبینیِ کاملِ فاز M09): دقیقاً هم‌الگو با fa.ts کنارش —
// transport.driverProfile.photosSectionTitle/photosHint با متنِ فعلیِ وب یکی شدند.
//
// 🛠️ همگام‌سازی با وب — هم‌زمان و دقیقاً هم‌الگو با dictionaries/fa.ts (رجوع کنید به کامنت
// کامل بالای همان فایل برای شرح کامل هر تغییر). خلاصه: همان کلیدهای فارسی، به پشتو.
...
export default {
  ...
  "common": {
    ...
    "comingSoon": "دا مخ لا جوړ شوی نه دی — ډېر ژر",
    "openSettingsButton": "د موبایل تنظیمات پرانیستل",
    "offlineNotice": "د انټرنیټ اړیکه قطع ده — سمدلاسه چې وصله شي، په خپلواکه توګه بیا هڅه کوو."
  },
  "dashboard": {
    ...
    "categories": {
      ...
      "realEstate": "املاک",
      "listingsSubtitle": "چټک او باوري پیرودل او پلورل",
      "transportSubtitle": "د ټکسي او سفر غوښتنه",
      "servicesSubtitle": "تخنیکي او کارګري خدمات",
      "realEstateSubtitle": "پیرودل، پلورل، ګروي او کرایه"
    },
    "quickAccessSubtitle": "اړین خدمات، په چټکه توګه"
  },
  "marketplace": {
    "categories": {
      "food": "خوراکي توکي",
    ...
    "wizard": {
      ...
      "errors": {
        ...
        "invalidProvince": "مهرباني وکړئ ولایت وټاکئ.",
    ...
    "myListings": {
      "title": "زما اعلانونه",
      "emptyTitle": "تر اوسه یې هیڅ اعلان نه دی ثبت کړی",
      "emptyDesc": "د لومړي اعلان ورزیاتولو لپاره د «نوی اعلان ثبت کړئ» تڼۍ وکاروئ.",
      "postAdButton": "نوی اعلان ثبت کړئ",
      "statusPending": "د تایید په تمه",
      "statusApproved": "تایید شوی او ښودل کیږي",
      "statusDeleted": "ړنګ شوی",
      "loginRequiredTitle": "لومړی ننوځئ",
      "loginRequiredDesc": "د خپلو اعلانونو کتلو لپاره، لومړی باید د خپل موبایل شمېرې سره حساب ته ننوځئ.",
      "loginRequiredButton": "حساب ته ننوتل",
      "dbError": "ستاسو د اعلانونو ترلاسه کول ونشول؛ بیا هڅه وکړئ."
    }
  },
  "transport": {
    "vehicleTypes": {
    ...
    "list": {
      ...
      "searchPlaceholder": "د ښار یا سیمې په نوم لټون وکړئ...",
      "searchButton": "لټون",
      "searchingButton": "لټون کیږي...",
      "searchNotFoundNotice": "د دې نوم سره هیڅ ښار یا سیمه و نه موندل شوه؛ بل نوم هڅه وکړئ یا د «نږدې موټر چلوونکي وښایاست» تڼۍ وکاروئ.",
      ...
      "locationBlockedNotice": "ستاسو ځای ته لاسرسی تل لپاره رد شوی دی. د نږدې موټر چلوونکو لیدلو لپاره، مهرباني وکړئ د دې اپلیکیشن د ځای لاسرسی د موبایل له تنظیماتو څخه فعال کړئ.",
      "locationServicesDisabledNotice": "ستاسو د موبایل د ځای موندنې خدمت (GPS) بند دی. مهرباني وکړئ دا د موبایل له تنظیماتو څخه روښانه کړئ.",
      "sortedByDistanceNotice": "ستاسو نږدې موټر چلوونکو پر بنسټ",
      "sortedBySearchNotice": "د «{query}» ته د نږدې موټر چلوونکو پر بنسټ",
    ...
    "driverProfile": {
      ...
      "locationTrackingDeniedNotice": "ستاسو ځای ته لاسرسی ورنکړل شو؛ په راتلونکي هڅه کې به بیا له تاسو وپوښتل شي — د غوښتونکو لخوا لیدلو لپاره، مهرباني وکړئ دا ځل لاسرسی تایید کړئ.",
      "locationTrackingBlockedNotice": "ستاسو ځای ته لاسرسی تل لپاره رد شوی دی. د غوښتونکو لخوا لیدلو لپاره، مهرباني وکړئ د دې اپلیکیشن د ځای لاسرسی د موبایل له تنظیماتو څخه فعال کړئ.",
      "locationTrackingUnsupportedNotice": "ستاسو د موبایل د ځای موندنې خدمت (GPS) بند دی.",
      "loginRequiredTitle": "لومړی ننوځئ",
      ...
      "errors": {
        ...
        "invalidVideoData": "ټاکل شوې ویډیو نه شي پروسس کیدای.",
        "notVip": "ویډیو ورزیاتول یوازې فعال VIP غړو لپاره دي.",
        "moduleDisabled": "د ټکسي او مسافر برخه اوس مهال غیرفعاله ده او ډېر ژر به فعاله شي."
      },
    ...
    "disabledNotice": {
      "title": "دا برخه اوس مهال غیرفعاله ده",
      "message": "د ټکسي او مسافر برخه اوس مهال غیرفعاله ده او ډېر ژر به فعاله شي."
    }
  },
  "services": {
    "providerProfile": {
    ...
    "list": {
      ...
      "locatingButton": "ستاسو ځای موندل کیږي...",
      "locationDeniedNotice": "ستاسو ځای ته لاسرسی ونشو؛ تاسو کولی شئ پرځای یې د ښار یا سیمې نوم په لټون کادر کې ولیکئ.",
      "locationBlockedNotice": "ستاسو ځای ته لاسرسی تل لپاره رد شوی دی. د نږدې متخصصینو لیدلو لپاره، مهرباني وکړئ د دې اپلیکیشن د ځای لاسرسی د موبایل له تنظیماتو څخه فعال کړئ.",
      "locationServicesDisabledNotice": "ستاسو د موبایل د ځای موندنې خدمت (GPS) بند دی. مهرباني وکړئ دا د موبایل له تنظیماتو څخه روښانه کړئ.",
  ...
  "stories": {
    ...
    "viewer": {
      ...
      "viewersButtonLabel": "لیدونکي",
      "viewersSheet": {
        "title": "لیدونکي",
        "closeLabel": "بندول",
        "loadErrorMessage": "د لیدونکو بارول ونشول.",
        "emptyTitle": "لا تر اوسه چا نه دی لیدلی",
        "emptyDesc": "کله چې یو څوک دا سټوري وګوري، دلته به ښکاره شي.",
    ...
    "addSection": {
      ...
      "addPhotoButton": "د عکس زیاتول",
      "addVideoButton": "د ویډیو زیاتول",
      "errors": {
        "unauthenticated": "د سټوري د زیاتولو لپاره لومړی خپل حساب ته ننوځئ.",
        "invalidMediaType": "ستاسو غوره شوی فایل ډول ملاتړ نه کیږي.",
        "invalidMediaData": "یو له عکسونو څخه د پروسس وړ نه دی.",
        "invalidVideoDuration": "د ویډیو موده ناسمه ده.",
        "dailyLimitReached": "تاسو خپلې ورځنۍ د سټوري سهمیې ته رسیدلي یاست.",
        "compressionFailed": "د دې رسنۍ پروسس ونشو؛ بل فایل هڅه وکړئ.",
        "uploadFailed": "اپلوډ ونشو؛ بیا هڅه وکړئ.",
        "dbError": "د سټوري ثبت ونشو؛ بیا هڅه وکړئ.",
        "generic": "یوه ستونزه رامنځته شوه؛ بیا هڅه وکړئ."
      }
    }
  },
  "chat": {
    ...
    "errors": {
      ...
      "voiceNotSupported": "ستاسو وسیله د غږیز پیغام ثبتولو ملاتړ نه کوي.",
      "microphonePermissionDenied": "د مایکروفون لاسرسی ونه شو ورکړل؛ د ګرځنده وسیلې تنظیماتو څخه اجازه ورکړئ.",
      "generic": "یوه ستونزه رامنځته شوه؛ بیا هڅه وکړئ."
    },
    "adminSupport": {
      "title": "د یکجا پشتیبانی",
      ...
      "adminPendingNotice": "دا د یو کاروونکي نوې د چت غوښتنه ده او تر اوسه ورته «فعال» نه ده شوې. د هر پیغام په لیږلو سره، دا خبرې اترې به ورته په اتوماتيک ډول فعال شي.",
      "errors": {
        "unauthenticated": "لومړی باید خپل حساب ته ننوځئ.",
        "unavailable": "اوس مهال د پشتیبانۍ سره د خبرو اترو پیلولو امکان نشته؛ مهرباني وکړئ وروسته بیا هڅه وکړئ.",
        "cannotChatWithSelf": "تاسو نشئ کولی له ځان سره خبرې اترې وکړئ.",
  ...
  "appUpdate": {
    "requiredTitle": "نوي کول اړین دي",
    "requiredDefaultMessage": "د یکجا د کارونې دوام لپاره، مهرباني وکړئ اپلیکیشن تر وروستي نسخې پورې نوی کړئ.",
    "availableTitle": "نوې نسخه شتون لري",
    "availableDefaultMessage": "د یکجا یوه نوې نسخه خپره شوې — وړاندیز کوو چې نوې یې کړئ.",
    "updateButton": "نوی کول",
    "laterButton": "وروسته",
    "currentVersionLabel": "اوسنۍ نسخه",
    "latestVersionLabel": "وروستۍ نسخه",
    "profileSectionTitle": "د اپلیکیشن نسخه",
    "upToDateStatus": "تازه ده",
    "outdatedStatus": "نوې نسخه شتون لري",
    "outdatedButton": "نوی کړئ"
  },
  "contact": {
    ...
    "domainVal": "yakja.top",
    "brandVal": "یکجا | YAKJA",
    "sectionTitle": "د یکجا معلومات او اړیکه",
    "whatsappLabel": "واتساپ",
    "extraInfoLabel": "بشپړوونکي معلومات"
  },
  "footer": {
  ...
  "exchangeRates": {
    "title": "اسعار",
    "subtitle": "د افغانستان په بازار کې د کارېدونکو اسعارو سمدستي نرخ",
    "sourceLabel": "سرچینه: د کابل سرای شهزاده",
    "buyLabel": "پیرودل",
    "sellLabel": "پلورل",
    "currencyLabel": "اسعار",
    "trendLabel": "بهیر",
    "afnLabel": "افغانۍ",
    "converterTitle": "چټک بدلوونکی",
    "amountPlaceholder": "مقدار ولیکئ",
    "resultLabel": "معادل:",
    "disclaimer": "نرخونه تقریبي دي او د کابل سرای شهزاده له بازار سره سمون لري؛ ممکن د صرافیو له سمدستي نرخ سره لږ توپیر ولري. مخکې له هرې معاملې، نرخ حتماً د صرافۍ سره تایید کړئ.",
    "justNowLabel": "همدا اوس",
    "minutesAgoTemplate": "{minutes} دقیقې مخکې",
    "hoursAgoTemplate": "{hours} ساعته مخکې",
    "perThousandBadgeLabel": "هر ۱۰۰۰",
    "perThousandNoteTemplate": "د {code} نرخ د هرو ۱۰۰۰ واحدو لپاره دی، نه ۱ واحد؛ پورتنی مبلغ پر همدې بنسټ محاسبه شوی."
  },
  "notFound": {
  ...
  "follows": {
    ...
    "followingLabel": "تعقیبېدونکي",
    "followButton": "فالو",
    "followBackButton": "بېرته فالو",
    "followingButton": "تعقیبوئ",
    "unfollowConfirmQuestion": "فالو لغوه شي؟",
    "unfollowConfirmYes": "هو",
    "unfollowConfirmCancel": "نه، پرېږده",
    "followersPageTitle": "پيروان",
    "followingPageTitle": "تعقیبېدونکي",
    "emptyFollowersTitle": "لا تر اوسه هیڅ پیرو نشته",
    "emptyFollowersDesc": "کله چې یو څوک دغه حساب فالو کړي، دلته ښکاره کیږي.",
    "emptyFollowingTitle": "لا تر اوسه یې هیڅوک تعقیب نه دي کړي",
    "emptyFollowingDesc": "کله چې دغه حساب یو کارن فالو کړي، دلته ښکاره کیږي.",
    "loadMore": "نور وښایاست",
    "loadingMore": "بارېږي…",
    "endOfList": "د لیست پای ته ورسېدئ",
    "loadMoreError": "بارول ونشول؛ بیا هڅه وکړئ.",
    "activityBellAriaLabel": "د فالو فعالیتونه",
    "activityPageTitle": "فعالیتونه",
    "emptyActivityTitle": "لا تر اوسه هیڅ فعالیت نشته",
    "emptyActivityDesc": "کله چې یو څوک تاسو فالو کړي، دلته به یې وګورئ.",
    "followedYouText": "تاسو یې فالو کړئ",
    "followedYouBackText": "ستاسو فالو ته یې ځواب ورکړ",
    "justNow": "همدا اوس",
    "minutesAgoTemplate": "{minutes} دقیقې مخکې",
    "hoursAgoTemplate": "{hours} ساعته مخکې",
    "daysAgoTemplate": "{days} ورځې مخکې",
    "loginRequiredTitle": "لومړی ننوځئ",
    "loginRequiredDesc": "د فالو د فعالیتونو لیدلو لپاره، لومړی باید د خپل موبایل شمېرې سره ننوځئ.",
    "loginRequiredButton": "حساب ته ننوتل",
    "errors": {
      "unauthenticated": "لومړی باید خپل حساب ته ننوځئ.",
      "invalidTarget": "دا کړنه پر دغه حساب امکان نه لري.",
      "userNotFound": "دغه کارن و نه موندل شو.",
      "dbError": "یوه ستونزه رامنځته شوه؛ بیا هڅه وکړئ.",
      "generic": "یوه ستونزه رامنځته شوه؛ بیا هڅه وکړئ."
    }
  }
};